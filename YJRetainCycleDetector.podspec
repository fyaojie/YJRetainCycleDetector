...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YJRetainCycleDetector.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/562925462@qq.com/YJRetainCycleDetector'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '562925462@qq.com' => 'yaojie.feng@symbio.com' }
  s.source           = { :git => 'https://github.com/562925462@qq.com/YJRetainCycleDetector.git', :tag => s.version.to_s }
